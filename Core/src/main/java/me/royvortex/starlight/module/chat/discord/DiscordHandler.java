package me.royvortex.starlight.module.chat.discord;
...
public class DiscordHandler extends SimpleManager<StarlightPlugin> {

    //private final ChatModule module;

    public DiscordHandler(@NotNull StarlightPlugin plugin, @NotNull ChatModule module) {
        super(plugin);
        //this.module = module;
    }
