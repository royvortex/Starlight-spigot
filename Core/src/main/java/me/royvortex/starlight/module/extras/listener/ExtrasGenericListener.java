package me.royvortex.starlight.module.extras.listener;
...
public class ExtrasGenericListener extends AbstractListener<StarlightPlugin> {

    public ExtrasGenericListener(@NotNull StarlightPlugin plugin, @NotNull ExtrasModule module) {
        super(plugin);
    }
