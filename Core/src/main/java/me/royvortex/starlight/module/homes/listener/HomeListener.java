package me.royvortex.starlight.module.homes.listener;
...
public class HomeListener extends AbstractListener<StarlightPlugin> {

    private final HomesModule module;

    public HomeListener(@NotNull StarlightPlugin plugin, @NotNull HomesModule module) {
        super(plugin);
        this.module = module;
    }
