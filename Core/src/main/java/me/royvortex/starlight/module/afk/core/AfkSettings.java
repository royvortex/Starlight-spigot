...
import me.royvortex.starlight.module.afk.ActivityType;
...
public class AfkSettings extends AbstractConfig {
    ...
    public final ConfigProperty<RankTable> idleAfkTimes = this.addProperty(STConfigTypes.RANK_TABLE, "AFK.Idle_Time",
    ...
    public final ConfigProperty<RankTable> idleKickTimes = this.addProperty(STConfigTypes.RANK_TABLE, "AFK.Kick_Time",
