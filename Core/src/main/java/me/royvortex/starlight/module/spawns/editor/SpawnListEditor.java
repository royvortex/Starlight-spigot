...
import static me.royvortex.starlight.module.spawns.SpawnsPlaceholders.SPAWN_ID;
import static me.royvortex.starlight.module.spawns.SpawnsPlaceholders.SPAWN_NAME;
...
public class SpawnListEditor extends AbstractMenu implements LangContainer {
    ...
    public SpawnListEditor(@NonNull StarlightPlugin plugin, @NonNull SpawnsModule module) {
