package me.royvortex.starlight.module.homes;
...
import me.royvortex.starlight.module.homes.command.HomeAdminCommandProvider;
import me.royvortex.starlight.module.homes.command.HomeCommonCommandProvider;
import me.royvortex.starlight.module.homes.config.HomesLang;
import me.royvortex.starlight.module.homes.config.HomesPerms;
import me.royvortex.starlight.module.homes.config.HomesSettings;
import me.royvortex.starlight.module.homes.data.HomeDataManager;
import me.royvortex.starlight.module.homes.dialog.HomeDialogKeys;
import me.royvortex.starlight.module.homes.dialog.impl.HomeDeleteDialog;
import me.royvortex.starlight.module.homes.dialog.impl.HomeInvitePlayerDialog;
import me.royvortex.starlight.module.homes.dialog.impl.HomeNameDialog;
import me.royvortex.starlight.module.homes.event.PlayerHomeCreateEvent;
import me.royvortex.starlight.module.homes.event.PlayerHomeRemoveEvent;
import me.royvortex.starlight.module.homes.event.PlayerHomeTeleportEvent;
import me.royvortex.starlight.module.homes.impl.Home;
import me.royvortex.starlight.module.homes.listener.HomeListener;
import me.royvortex.starlight.module.homes.menu.HomeSettingsMenu;
import me.royvortex.starlight.module.homes.menu.HomesMenu;
import me.royvortex.starlight.module.homes.menu.IconSelectionMenu;
import me.royvortex.starlight.module.homes.menu.InvitedPlayersMenu;
import me.royvortex.starlight.module.homes.repository.GlobalHomeRepository;
import me.royvortex.starlight.module.homes.repository.UserHomeRepository;
        ...
        if (!force) {
            ...
            if (currentHome == null && maxHomesValue >= 0 && countHomes >= maxHomesValue) {
                this.sendPrefixed(HomesLang.HOME_SET_ERROR_LIMIT, player, builder -> builder
                    .with(STPlaceholders.GENERIC_AMOUNT, () -> String.valueOf(countHomes))
                    .with(STPlaceholders.GENERIC_MAX, () -> String.valueOf(maxHomesValue))
                );
                return false;
            }
