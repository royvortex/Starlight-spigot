...
import me.royvortex.starlight.STLinks;
import me.royvortex.starlight.module.bans.punishment.PunishmentReason;
...
public class BansSettings extends AbstractConfig {
    ...
    public final ConfigProperty<Map<Integer, List<String>>> warnAutoCommands = this.addProperty(
        ...
        "[*] Placeholders: '%s', '%s'".formatted(PLAYER_NAME, "Punishment (" + STLinks.WIKI_PLACEHOLDERS + ")")
    );
