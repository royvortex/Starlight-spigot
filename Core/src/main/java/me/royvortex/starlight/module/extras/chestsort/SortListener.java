package me.royvortex.starlight.module.extras.chestsort;
...
public class SortListener extends AbstractListener<StarlightPlugin> {

    private final SortManager manager;

    public SortListener(@NotNull StarlightPlugin plugin, @NotNull SortManager manager) {
        super(plugin);
