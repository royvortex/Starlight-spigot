...
import me.royvortex.starlight.module.chat.ChatProperties;
...
public class SpyCommandProvider extends AbstractCommandProvider {
    ...
    public SpyCommandProvider(@NotNull StarlightPlugin plugin, @NotNull ChatModule module, @NotNull UserManager userManager) {
        super(plugin);
        this.module = module;
    ...
    private void builderMode(@NotNull LiteralNodeBuilder builder, @NotNull SpyType spyType, @NotNull ToggleMode mode) {
        ...
        builder
            .description(description.text().replace(STPlaceholders.GENERIC_TYPE, ChatLang.SPY_TYPE.getLocalized(spyType)))
        ...
        return this.loadPlayerOrSenderWithDataAndRunInMainThread(context, arguments, this.module, this.userManager, (user, target) -> {
            ...
            if (context.getSender() != target) {
                this.module.sendPrefixed(ChatLang.SPY_MODE_TOGGLE_FEEDBACK, context.getSender(), replacer -> replacer
                    ...
                    .with(STPlaceholders.GENERIC_TYPE, () -> ChatLang.SPY_TYPE.getLocalized(spyType))
