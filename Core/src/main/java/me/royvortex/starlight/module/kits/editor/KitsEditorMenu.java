...
import static me.royvortex.starlight.module.kits.KitsPlaceholders.KIT_ID;
...
public class KitsEditorMenu extends AbstractMenu implements LangContainer {
    ...
    public KitsEditorMenu(@NonNull StarlightPlugin plugin, @NonNull KitsModule module) {
