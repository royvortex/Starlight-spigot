...
import me.royvortex.starlight.module.playerwarps.PlayerWarpsPlaceholders;
import me.royvortex.starlight.module.playerwarps.PlayerWarpRepository;
...
import static me.royvortex.starlight.module.warps.WarpsPlaceholders.*;
...
public class PlayerWarpsListMenu extends AbstractObjectMenu<WarpsListData> implements LangContainer {
    ...
    public PlayerWarpsListMenu(@NonNull StarlightPlugin plugin, @NonNull PlayerWarpsModule module, @NonNull PlayerWarpsSettings settings, @NonNull PlayerWarpRepository repository) {
