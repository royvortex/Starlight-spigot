...
public class TeleportCommandsProvider extends AbstractCommandProvider {
    ...
    public TeleportCommandsProvider(@NotNull StarlightPlugin plugin, @NotNull EssentialModule module, @NotNull UserManager userManager, @NotNull TeleportManager teleportManager) {
        super(plugin);
        this.module = module;
