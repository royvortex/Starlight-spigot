...
import static me.royvortex.starlight.STPlaceholders.GENERIC_COMMAND;
...
public class ForceRunCommandProvider extends AbstractCommandProvider {
    ...
    public ForceRunCommandProvider(@NotNull StarlightPlugin plugin, @NotNull EssentialModule module) {
        super(plugin);
        this.module = module;
    }
