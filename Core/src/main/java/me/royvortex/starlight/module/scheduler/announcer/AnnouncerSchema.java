package me.royvortex.starlight.module.scheduler.announcer;
...
public class AnnouncerSchema {
    ...
    public static final ConfigProperty<Set<String>> RANKS = ConfigProperty.of(ConfigTypes.STRING_SET_LOWER_CASE, "Ranks", Set.of(STPlaceholders.WILDCARD),
