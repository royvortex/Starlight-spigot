package me.royvortex.starlight.module.chat.report;
...
public final class ReportProtocolHandler implements ReportHandler {
    ...
    public ReportProtocolHandler(@NotNull StarlightPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    private static class Listener extends PacketAdapter {
        ...
        public Listener(@NotNull StarlightPlugin plugin) {
