package me.royvortex.starlight.module.playerwarps.command;
...
public class PlayerWarpsCommands extends AbstractCommandProvider {
    ...
    public PlayerWarpsCommands(@NonNull StarlightPlugin plugin, @NonNull PlayerWarpsModule module, @NonNull UserManager userManager) {
        super(plugin);
        this.module = module;
