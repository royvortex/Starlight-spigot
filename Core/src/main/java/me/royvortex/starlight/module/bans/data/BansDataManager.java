package me.royvortex.starlight.module.bans.data;
...
public class BansDataManager {
    ...
    public BansDataManager(@NotNull StarlightPlugin plugin, @NotNull DataHandler dataHandler, @NotNull BansModule module) {
        //this.plugin = plugin;
