package me.royvortex.starlight.module.afk.listener;
...
public class AfkListener extends AbstractListener<StarlightPlugin> {

    private final AfkModule module;

    public AfkListener(@NotNull StarlightPlugin plugin, @NotNull AfkModule module) {
        super(plugin);
        this.module = module;
    }
