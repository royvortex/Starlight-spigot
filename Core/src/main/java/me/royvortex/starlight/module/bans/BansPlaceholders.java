...
import me.royvortex.starlight.module.bans.punishment.AbstractPunishment;
import me.royvortex.starlight.module.bans.punishment.InetPunishment;
import me.royvortex.starlight.module.bans.punishment.PlayerPunishment;
import me.royvortex.starlight.STUtils;

public class BansPlaceholders extends STPlaceholders {
    ...
    private static final TypedPlaceholder<AbstractPunishment> PUNISHMENT = TypedPlaceholder.builder(AbstractPunishment.class)
        ...
        .with(PUNISHMENT_WHO, punishment -> STUtils.getSenderName(punishment.getWho())) // TODO Better
