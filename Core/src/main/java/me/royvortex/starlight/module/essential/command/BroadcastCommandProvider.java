...
public class BroadcastCommandProvider extends AbstractCommandProvider {
    ...
    public BroadcastCommandProvider(@NotNull StarlightPlugin plugin, @NotNull List<String> format) {
        super(plugin);
    ...
    private boolean broadcast(@NotNull CommandContext context, @NotNull ParsedArguments arguments) {
        ...
        String message = this.format.replace(STPlaceholders.GENERIC_MESSAGE, text);
