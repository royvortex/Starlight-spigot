package me.royvortex.starlight.module.inventories.command;
...
import me.royvortex.starlight.api.PortableContainer;
...
import me.royvortex.starlight.module.inventories.InventoriesPerms;
...
import static me.royvortex.starlight.STPlaceholders.GENERIC_TYPE;
...
public class ContainerCommandProvider extends AbstractCommandProvider {
    ...
    public ContainerCommandProvider(@NotNull StarlightPlugin plugin, @NotNull InventoriesModule module, @NotNull SunNMS nms) {
        super(plugin);
        this.module = module;
        this.nms = nms;
    }
    ...
    public void registerDefaults() {
        ...
        Stream.of(PortableContainer.values()).forEach(container -> {
            ...
            this.registerLiteral(label, true, new String[]{label}, builder -> builder
                .description(DESCRIPTION_TYPE.text().replace(STPlaceholders.GENERIC_TYPE, CONTAINER_LOCALE.getLocalized(
                    container)))
        ...
        return this.runForOnlinePlayerOrSender(context, arguments, this.module, target -> {
            ...
            if (context.getSender() != target) {
                this.module.sendPrefixed(MESSAGE_TARGETTED, context.getSender(), builder -> builder
                    ...
                    .with(STPlaceholders.GENERIC_TYPE, () -> CONTAINER_LOCALE.getLocalized(container))
                );
            }
