package me.royvortex.starlight.module.homes.config;
...
import me.royvortex.starlight.module.homes.impl.HomeType;

import static su.nightexpress.nightcore.util.text.night.wrapper.TagWrappers.*;
import static me.royvortex.starlight.module.homes.HomePlaceholders.*;
...
public class HomesLang extends Lang {
    ...
    public static final MessageLocale HOME_SET_ERROR_LIMIT = LangEntry.builder("Homes.Home.Set.Error.Limit").chatMessage(
        Sound.ENTITY_VILLAGER_NO,
        GRAY.wrap("You have a maximum " + ORANGE.wrap(GENERIC_AMOUNT) + " of " + ORANGE.wrap(STPlaceholders.GENERIC_MAX) + " homes created.")
    );
