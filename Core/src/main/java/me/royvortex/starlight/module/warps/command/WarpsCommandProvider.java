package me.royvortex.starlight.module.warps.command;
...
public class WarpsCommandProvider extends AbstractCommandProvider {
    ...
    public WarpsCommandProvider(@NonNull StarlightPlugin plugin, @NonNull WarpsModule module, @NonNull UserManager userManager) {
        super(plugin);
        this.module = module;
