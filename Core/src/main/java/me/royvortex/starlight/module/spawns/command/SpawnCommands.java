package me.royvortex.starlight.module.spawns.command;
...
public class SpawnCommands extends AbstractCommandProvider {
    ...
    public SpawnCommands(@NotNull StarlightPlugin plugin, @NotNull SpawnsModule module, @NotNull UserManager userManager) {
        super(plugin);
        this.module = module;
    ...
    private boolean setSpawn(@NotNull CommandContext context, @NotNull ParsedArguments arguments) {
        ...
        String spawnId = arguments.getString(CommandArguments.NAME, STPlaceholders.DEFAULT);
