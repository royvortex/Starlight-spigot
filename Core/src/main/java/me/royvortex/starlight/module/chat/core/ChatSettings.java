package me.royvortex.starlight.module.chat.core;
...
import static me.royvortex.starlight.STPlaceholders.GENERIC_MESSAGE;
import static me.royvortex.starlight.STPlaceholders.GENERIC_TARGET;
import static me.royvortex.starlight.module.chat.ChatPlaceholders.CHANNEL_NAME;
import static me.royvortex.starlight.module.chat.ChatPlaceholders.ITEM_NAME;
import static me.royvortex.starlight.module.chat.ChatPlaceholders.ITEM_VALUE;
...
import me.royvortex.starlight.module.chat.ChatDefaults;
import me.royvortex.starlight.module.chat.ChatFiles;
import me.royvortex.starlight.module.chat.format.FormatComponent;
import me.royvortex.starlight.module.chat.format.FormatDefinition;
import me.royvortex.starlight.module.chat.mention.GroupMention;
...
public class ChatSettings extends AbstractConfig {
    ...
    private final ConfigProperty<String> roleplayMeFormat = this.addProperty(ConfigTypes.STRING,
        ...
        ITALIC.wrap(SOFT_AQUA.wrap(PLAYER_DISPLAY_NAME) + " " + GRAY.wrap(STPlaceholders.GENERIC_MESSAGE)),
    ...
    private final ConfigProperty<Map<String, FormatComponent>> formatComponents = this.addProperty(ConfigTypes
        ...
        "[>] Text Formations: " + STPlaceholders.URL_WIKI_TEXT,
        "[>] %s Support: Yes".formatted(Plugins.PLACEHOLDER_API),
        "[>] Built-in Placeholders:",
        "- " + STPlaceholders.GENERIC_MESSAGE + " - Original message sent by a player.",
    ...
    private final ConfigProperty<Map<String, FormatDefinition>> formatDefinitions = this.addProperty(ConfigTypes
        ...
        "    - Ranks: List of ranks (permission group names) to which this format is applicable. Add '%s' to allow any rank."
            .formatted(STPlaceholders.WILDCARD),
    ...
    private final ConfigProperty<String> formatFallback = this.addProperty(ConfigTypes.STRING, "Chat.Format.Fallback",
        PLAYER_NAME + ": " + STPlaceholders.GENERIC_MESSAGE,
    ...
    private final ConfigProperty<String> conversationProxyFormat = this.addProperty(ConfigTypes.STRING,
        ...
        STPlaceholders.GENERIC_MESSAGE,
    ...
    private final ConfigProperty<String> conversationIncomingFormat = this.addProperty(ConfigTypes.STRING,
        ...
        "[>] Use the %s placeholder to insert 'basic' conversation format from the 'Format.Basic' section above"
            .formatted(STPlaceholders.GENERIC_FORMAT),
    ...
    private final ConfigProperty<String> itemShowFormat = this.addProperty(ConfigTypes.STRING, "ItemShow.Format",
        ...
        "Item display format.",
        "[>] Text Formations: %s".formatted(STPlaceholders.URL_WIKI_TEXT),
        "[>] Placeholders:",
