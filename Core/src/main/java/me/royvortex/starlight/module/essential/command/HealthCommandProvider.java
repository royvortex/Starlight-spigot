...
public class HealthCommandProvider extends AbstractCommandProvider {
    ...
    public HealthCommandProvider(@NotNull StarlightPlugin plugin, @NotNull EssentialModule module, @NotNull EssentialSettings settings, @NotNull UserManager userManager) {
        super(plugin);
        this.module = module;
