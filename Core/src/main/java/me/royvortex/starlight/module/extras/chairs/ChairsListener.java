package me.royvortex.starlight.module.extras.chairs;
...
public class ChairsListener extends AbstractListener<StarlightPlugin> {

    private final ChairsManager chairsManager;

    public ChairsListener(@NotNull StarlightPlugin plugin, @NotNull ChairsManager chairsManager) {
        super(plugin);
