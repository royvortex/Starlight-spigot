package me.royvortex.starlight.module.spawns.listener;
...
public class SpawnListener extends AbstractListener<StarlightPlugin> {

    private final SpawnsModule module;

    public SpawnListener(@NotNull StarlightPlugin plugin, @NotNull SpawnsModule module) {
        super(plugin);
        this.module = module;
    }
