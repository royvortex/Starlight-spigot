...
public class FoodLevelCommandProvider extends AbstractCommandProvider {
    ...
    public FoodLevelCommandProvider(@NotNull StarlightPlugin plugin, @NotNull EssentialModule module, @NotNull EssentialSettings settings, @NotNull UserManager userManager) {
        super(plugin);
        this.module = module;
