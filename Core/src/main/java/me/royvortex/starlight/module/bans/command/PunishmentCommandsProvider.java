...
import me.royvortex.starlight.module.bans.punishment.PunishmentContext;
...
public class PunishmentCommandsProvider extends AbstractCommandProvider {
    ...
    public PunishmentCommandsProvider(@NotNull StarlightPlugin plugin, @NotNull BansModule module, @NotNull UserManager userManager) {
        super(plugin);
        this.module = module;
