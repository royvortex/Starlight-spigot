package me.royvortex.starlight.module.homes.command;
...
import me.royvortex.starlight.module.homes.HomeDefaults;
import me.royvortex.starlight.module.homes.HomePlaceholders;
...
public class HomeAdminCommandProvider extends AbstractCommandProvider {
    ...
    public HomeAdminCommandProvider(@NotNull StarlightPlugin plugin, @NotNull HomesModule module, @NotNull UserManager userManager) {
        super(plugin);
        this.module = module;
