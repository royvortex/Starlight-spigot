package me.royvortex.starlight.module.homes.dialog.impl;
...
public class HomeInvitePlayerDialog extends Dialog<Home> {
    ...
    public HomeInvitePlayerDialog(@NotNull StarlightPlugin plugin, @NotNull HomesModule module, @NotNull UserManager userManager) {
        this.plugin = plugin;
        this.module = module;
