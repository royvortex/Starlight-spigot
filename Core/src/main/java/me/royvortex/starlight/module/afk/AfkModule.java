...
import me.royvortex.starlight.module.afk.command.AfkCommandProvider;
import me.royvortex.starlight.module.afk.core.AfkLang;
import me.royvortex.starlight.module.afk.core.AfkPerms;
import me.royvortex.starlight.module.afk.core.AfkSettings;
import me.royvortex.starlight.module.afk.event.PlayerAfkEvent;
import me.royvortex.starlight.module.afk.listener.AfkListener;
...
public class AfkModule extends Module implements AfkProvider {
    ...
    public void registerPlaceholders(@NotNull PlaceholderRegistry registry) {
        ...
        registry.register("afk_mode", (player, payload) -> {
            return PlaceholderContext.builder()
                .with(STPlaceholders.GENERIC_TIME, () -> TimeFormats.formatSince(this.getAfkEnterTimestamp(player), TimeFormatType.LITERAL))
                .build()
    ...
    public void kickForIdling(@NotNull Player player) {
        String reason = PlaceholderContext.builder()
            .with(STPlaceholders.GENERIC_TIME, () -> TimeFormats.formatAmount(TimeUnit.MILLISECONDS.convert(this.getIdleTime(player), TimeUnit.SECONDS), TimeFormatType.LITERAL))
            .andThen(STPlaceholders.forPlayerWithPAPI(player))
            .build()
            ...
            if (tracker.isAfk()) {
                ...
                if (this.settings.afkStatusBarEnabled.get()) {
                    Players.sendActionBar(player, PlaceholderContext.builder()
                        .with(STPlaceholders.GENERIC_TIME, () -> TimeFormats.formatSince(tracker.getAfkEnterTimestamp(), TimeFormatType.LITERAL))
                        .andThen(STPlaceholders.forPlayerWithPAPI(player))
                        .build()
