package me.royvortex.starlight.module.playerwarps.core;
...
public class PlayerWarpsSettings extends AbstractConfig {
    ...
    private final ConfigProperty<RankTable> warpsAmountPerRank = this.addProperty(STConfigTypes.RANK_TABLE, "Warp.Amount_Per_Rank",
