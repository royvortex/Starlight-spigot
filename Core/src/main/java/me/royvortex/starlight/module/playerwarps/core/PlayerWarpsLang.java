...
import static me.royvortex.starlight.module.playerwarps.PlayerWarpsPlaceholders.*;
...
public class PlayerWarpsLang implements LangContainer {
    ...
    public static final MessageLocale WARP_CREATION_LIMIT_REACHED = LangEntry.builder("PlayerWarps.Warp.Creation.LimitReached").chatMessage(
        Sound.ENTITY_VILLAGER_NO,
        GRAY.wrap("You already have created " + RED.wrap(GENERIC_AMOUNT) + "/" + RED.wrap(STPlaceholders.GENERIC_MAX) + " warps allowed.")
    );
