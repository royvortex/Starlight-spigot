...
public class IconSelectionMenu extends AbstractObjectMenu<Home> {
    ...
    public IconSelectionMenu(@NonNull StarlightPlugin plugin, @NonNull HomesModule module) {
        ...
        this.iconPopulator = ItemPopulator.builder(HomeIcon.class)
            ...
            .itemProvider((context, homeIcon) -> {
                ...
                return NightItem.fromItemStack(itemStack)
                    ...
                    .replace(builder -> builder.with(STPlaceholders.GENERIC_NAME, () -> ItemUtil.getNameSerialized(
                        itemStack)))
                    .hideAllComponents();
            })
            .slots(iconSlots)
