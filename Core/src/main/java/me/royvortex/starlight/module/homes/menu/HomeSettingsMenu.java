package me.royvortex.starlight.module.homes.menu;
...
import static me.royvortex.starlight.module.homes.HomePlaceholders.HOME_FAVORITE;
import static me.royvortex.starlight.module.homes.HomePlaceholders.HOME_INVITED_PLAYERS;
import static me.royvortex.starlight.module.homes.HomePlaceholders.HOME_NAME;
import static me.royvortex.starlight.module.homes.HomePlaceholders.HOME_TYPE;
...
import me.royvortex.starlight.module.homes.HomesFiles;
...
public class HomeSettingsMenu extends AbstractObjectMenu<Home> {
    ...
    public HomeSettingsMenu(@NonNull StarlightPlugin plugin, @NonNull HomesModule module) {
