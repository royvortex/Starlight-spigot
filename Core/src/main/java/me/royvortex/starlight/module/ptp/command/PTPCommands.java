package me.royvortex.starlight.module.ptp.command;
...
import me.royvortex.starlight.module.ptp.PTPProperties;
...
public class PTPCommands extends AbstractCommandProvider {
    ...
    public PTPCommands(@NotNull StarlightPlugin plugin, PTPModule module, @NotNull UserManager userManager) {
        super(plugin);
        this.module = module;
