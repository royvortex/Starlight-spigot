package me.royvortex.starlight.module.spawns.editor;
...
import static me.royvortex.starlight.module.spawns.SpawnsPlaceholders.SPAWN_WORLD;
import static me.royvortex.starlight.module.spawns.SpawnsPlaceholders.SPAWN_X;
import static me.royvortex.starlight.module.spawns.SpawnsPlaceholders.SPAWN_Y;
import static me.royvortex.starlight.module.spawns.SpawnsPlaceholders.SPAWN_Z;
...
import me.royvortex.starlight.module.spawns.Spawn;
import me.royvortex.starlight.module.spawns.SpawnsModule;
import me.royvortex.starlight.module.spawns.config.SpawnsLang;
import me.royvortex.starlight.module.spawns.dialog.SpawnsDialogKeys;
...
public class SpawnSettingsEditor extends AbstractObjectMenu<Spawn> implements LangContainer {
    ...
    private static final IconLocale ICON_RESPAWN_RULES = LangEntry.iconBuilder("Spawns.Editor.Spawn.RespawnRules")
        .name("Respawn Rules")
        .appendCurrent("Status", STPlaceholders.GENERIC_STATE).br()
    ...
    private static final IconLocale ICON_PRIORITY = LangEntry.iconBuilder("Spawns.Editor.Spawn.Priority")
        .name("Priority")
        .appendCurrent("Current", STPlaceholders.GENERIC_VALUE).br()
    ...
    private static final IconLocale ICON_NAME = LangEntry.iconBuilder("Spawns.Editor.Spawn.Name")
        .name("Name")
        .appendCurrent("Current", STPlaceholders.GENERIC_NAME).br()
        .appendClick("Click to change")
        .build();

    private final SpawnsModule module;

    public SpawnSettingsEditor(@NonNull StarlightPlugin plugin, @NonNull SpawnsModule module) {
    ...
    public void defineDefaultLayout() {
        ...
        this.addDefaultButton("name", MenuItem.button()
            .defaultState(ItemState.builder()
                ...
                .displayModifier((context, item) -> item.replace(builder -> builder
                    .with(STPlaceholders.GENERIC_NAME, () -> this.getObject(context).getName())
                ))
                .action(context -> {
        ...
        this.addDefaultButton("permission", MenuItem.button()
            .defaultState(ItemState.builder()
                ...
                .displayModifier((context, item) -> item.replace(builder -> builder
                    .with(STPlaceholders.GENERIC_STATE, () -> CoreLang.STATE_ENABLED_DISALBED.get(this.getObject(
        ...
        this.addDefaultButton("priority", MenuItem.button()
            .defaultState(ItemState.builder()
                ...
                .displayModifier((context, item) -> item.replace(builder -> builder
                    .with(STPlaceholders.GENERIC_VALUE, () -> String.valueOf(this.getObject(context).getPriority()))
                ))
                .action(context -> {
