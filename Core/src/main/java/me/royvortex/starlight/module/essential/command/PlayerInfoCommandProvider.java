...
import me.royvortex.starlight.STSharedConsts;
...
import me.royvortex.starlight.module.essential.EssentialPlaceholders;
...
import static me.royvortex.starlight.STPlaceholders.forLocation;
import static me.royvortex.starlight.STPlaceholders.forPlayerWithPAPI;
...
public class PlayerInfoCommandProvider extends AbstractCommandProvider {
    ...
    public PlayerInfoCommandProvider(@NonNull StarlightPlugin plugin, @NonNull EssentialModule module, @NonNull EssentialSettings settings, @NonNull UserManager userManager) {
        super(plugin);
        this.module = module;
    ...
    public void registerDefaults() {
        this.registerLiteral("playerinfo", true, new String[]{"playerinfo", STSharedConsts.COMMAND_PLAYER_INFO},
            builder -> builder
