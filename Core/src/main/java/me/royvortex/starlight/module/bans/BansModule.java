package me.royvortex.starlight.module.bans;
...
import me.royvortex.starlight.module.bans.command.*;
import me.royvortex.starlight.module.bans.config.BansLang;
import me.royvortex.starlight.module.bans.config.BansPerms;
import me.royvortex.starlight.module.bans.config.BansSettings;
import me.royvortex.starlight.module.bans.data.BansDataManager;
import me.royvortex.starlight.module.bans.listener.BansListener;
import me.royvortex.starlight.module.bans.menu.HistoryMenu;
import me.royvortex.starlight.module.bans.menu.PunishmentsMenu;
import me.royvortex.starlight.module.bans.punishment.*;
import me.royvortex.starlight.module.bans.time.BanTime;
import me.royvortex.starlight.module.bans.time.BanTimeUnit;
...
public class BansModule extends Module {
    ...
    private void kickBanned() {
        Players.getOnline().forEach(player -> {
            AbstractPunishment punishment = this.bansRepository.getActivePlayerOrInetPunishment(player.getUniqueId(),
                STUtils.getInetAddress(player).orElse(null));
    ...
    public PunishmentReason getDefaultReason() {
        PunishmentReason reason = this.getReasonById(STPlaceholders.DEFAULT);
    ...
    public void handleJoin(@NotNull PlayerJoinEvent event) {
        ...
        STUtils.getInetAddress(player).ifPresent(address -> this.lookupAltProfiles(address).thenAccept(alts -> {
    ...
    public boolean kick(@NotNull CommandSender sender, @NotNull Player victim, @NotNull PunishmentReason reason,
        ...
        PlaceholderContext context = PlaceholderContext.builder()
            ...
            .with(BansPlaceholders.GENERIC_EXECUTOR, () -> STUtils.getSenderName(sender))
            ...
            .with(BansPlaceholders.PUNISHMENT_WHO, () -> STUtils.getSenderName(sender)) // old
            .build();
    ...
    private boolean punishPlayer(@NotNull CommandSender sender, @NotNull UserInfo victim, int victimPriority,
        ...
        if (!sender.hasPermission(BansPerms.BYPASS_DURATION_LIMIT)) {
            ...
            if (banTime.isGreater(maxTime)) {
                ...
                this.sendPrefixed(locale, sender, builder -> builder.with(STPlaceholders.GENERIC_TIME, () -> TimeFormats
        ...
        if (type == PunishmentType.WARN) {
            ...
            if (commands != null && !commands.isEmpty()) {
                PlaceholderContext commandsContext = PlaceholderContext.builder()
                    ...
                    .with(STPlaceholders.PLAYER_NAME, () -> playerName)
                    .build();
    ...
    public void notifyAltProfiles(@NotNull CommandSender sender, @NotNull UserInfo profile,
        ...
        PlaceholderContext context = PlaceholderContext.builder()
            ...
            .with(STPlaceholders.GENERIC_AMOUNT, () -> String.valueOf(alts.size()))
            .with(STPlaceholders.GENERIC_ADDRESS, address::getHostAddress)
            .with(STPlaceholders.GENERIC_ENTRY, () -> alts.stream()
                .map(alt -> PlaceholderContext.builder().with(STPlaceholders.GENERIC_NAME, alt::name).build().apply(
