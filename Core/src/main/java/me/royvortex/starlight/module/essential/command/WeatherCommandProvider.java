...
public class WeatherCommandProvider extends AbstractCommandProvider {
    ...
    public WeatherCommandProvider(@NotNull StarlightPlugin plugin, @NotNull EssentialModule module) {
        super(plugin);
        this.module = module;
    }
    ...
    public void registerDefaults() {
        ...
        for (Type type : Type.values()) {
            ...
            this.registerLiteral(name, true, new String[]{name}, builder -> builder
                .description(DESCRIPTION_TYPE.text().replace(STPlaceholders.GENERIC_TYPE, WEATHER_TYPE.getLocalized(type)))
