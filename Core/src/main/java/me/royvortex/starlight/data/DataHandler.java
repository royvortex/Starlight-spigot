...
import me.royvortex.starlight.data.serialize.CommandKeySerializer;
import me.royvortex.starlight.data.serialize.UserInfoSerializer;
...
public class DataHandler extends AbstractDatabaseManager<StarlightPlugin> implements UserDataSchema<SunUser> {
    ...
    public DataHandler(@NotNull StarlightPlugin plugin) {
        super(plugin);
